				...
				<div class="flex flex-col text-neutral-50 w-3/5 border-4 border-stone-50 py-10 px-5 rounded">
					...
					<nav class="flex justify-center gap-3 mt-4">
						<ul class="grid grid-cols-2 justify-center items-center w-full m-0 gap-4">
							<li class="text-center bg-orange-50 hover:bg-orange-500 text-stone-950 hover:text-stone-800 p-1.5 mt-5 font-bold flex justify-center items-center">
								<a href="/forgotpassword">{login.forgotpass}</a>
							</li>
							<li class="text-center bg-slate-50 hover:bg-slate-700 text-stone-700 hover:text-stone-50 p-1.5 mt-5 font-bold flex justify-center items-center">
								<a href="/createaccont">{login.createAcc}</a>
							</li>
						</ul>
