...
const tools = "/_app/immutable/assets/tool3.BJiGKhYJ.jpg";
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<img${add_attribute("src", tools, 0)} alt="background tools" class="w-full object-cover h-96"> <div class="flex items-start justify-center min-h-screen bg-bgdarkgrey"><main class="grid grid-cols-3 gap-4 p-5 font-patrick">${each(kgProducts, (PRODUCT) => {
